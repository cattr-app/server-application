...
class Settings
{
    ...
    {
        return (bool)static::get(Property::COMPANY_CODE, 0, static::SYNC_TIME_PERIOD, 'daily');
    }

    public function setTimeSyncPeriod(string $period): Property
    {
        return static::set(Property::COMPANY_CODE, 0, static::SYNC_TIME_PERIOD, $period);
    }

    // Trello Auth Token getter and setter
    public function setAuthToken(string $authToken): string
    {
        return static::set(Property::COMPANY_CODE, 0, static::AUTH_TOKEN, $authToken);
    }

    public function getAuthToken(): string
    {
        return static::get(Property::COMPANY_CODE, 0, static::AUTH_TOKEN, '');
    }

    public function setOrganizationName($organizationName): string
    {
        return static::set(Property::COMPANY_CODE, 0, static::ORGANIZATION_NAME, $organizationName);
    }

    public function getOrganizationName(): string
    {
        return static::get(Property::COMPANY_CODE, 0, static::ORGANIZATION_NAME, '');
    }

    // User API key's getter and setter
    public function getUserApiKey(int $userId): string
    {
        return static::get(Property::USER_CODE, $userId, static::API_KEY, '');
    }

    public function setUserApiKey(int $userId, string $token): Property
    {
        return static::set(Property::USER_CODE, $userId, static::API_KEY, $token);
    }
}
