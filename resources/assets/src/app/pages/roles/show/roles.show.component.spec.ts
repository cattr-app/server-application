...
describe('Roles show component(Admin)', () => {
  let component, fixture;
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [RolesShowComponent, DualListComponent],
  ...
  it('contains field ID for role', async(() => {
    const el = fixture.debugElement.query(By.all()).nativeElement;
    expect(el.innerHTML).toContain('field.id');
  }));

  it('contains field Name for role', async(() => {
    const el = fixture.debugElement.query(By.all()).nativeElement;
