...
class TaskDeleted implements ShouldBroadcastNow
{
    ...
    public function broadcastOn(): array
    {
        ...
        return array_map(fn($userId) => new PrivateChannel("TaskDeleted.{$userId}"), array_unique(array_merge($this->users->toArray(), $companyAdminsAndManagersIds->toArray()), SORT_REGULAR));
    }
}
